...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.glytrait_label.setGeometry(QRect(10, 10, 111, 31))
        font = QFont()
        ...
        self.gridLayout.addWidget(self.sia_checkbox, 6, 0, 1, 1)
        ...
        self.advance_label.setGeometry(QRect(20, 370, 181, 21))
        self.advance_label.setFont(font3)
        self.line_2 = QFrame(self.centralwidget)
        self.line_2.setObjectName("line_2")
        self.line_2.setGeometry(QRect(20, 390, 601, 20))
        self.line_2.setFrameShape(QFrame.HLine)
        self.line_2.setFrameShadow(QFrame.Sunken)
        self.horizontalLayoutWidget = QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setObjectName("horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(20, 410, 601, 80))
        ...
        self.groupBox_2.setGeometry(QRect(20, 520, 601, 51))
        self.run_button = QPushButton(self.groupBox_2)
        self.run_button.setObjectName("run_button")
        self.run_button.setGeometry(QRect(190, 10, 201, 31))
        font4 = QFont()
